...
public class GraphController extends Group {
	...
	private void setLayout() {
		...
		pane.setMargin(spR, new Insets(0, 0, 0, 10));
		...
		pane.setMargin(spL, new Insets(0, 10, 0, 0));
	...
	//returns a linechart
	public LineChart<Number, Number> addLineChart(String title, String xLabel, String yLabel, ArrayList<XYChart.Series> series) {
	...
	public ScatterChart<Number, Number> addScatterChart(String title, String xLabel, ArrayList<Number> xVals, String yLabel, ArrayList<Number> yVals) {
		final NumberAxis xAxis = new NumberAxis();
		xAxis.setLabel(xLabel);
		final NumberAxis yAxis = new NumberAxis();
		yAxis.setLabel(yLabel);
	...
	public AreaChart<Number, Number> addAreaChart(String title, String xLabel, String yLabel, ArrayList<XYChart.Series> series) {
		final NumberAxis xAxis = new NumberAxis();
		xAxis.setLabel(xLabel);
		final NumberAxis yAxis = new NumberAxis();
		yAxis.setLabel(yLabel);
